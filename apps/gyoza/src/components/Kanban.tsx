...
export const Kanban: React.FC = () => {
  ...
  return (
    <div className="flex w-full flex-col items-center gap-y-2 overflow-x-auto p-4">
      <CreateColumnModal />
      <div className={'flex h-[75vh] items-center justify-center gap-x-2 overflow-x-auto sm:h-[80vh]'}>
        {isLoading ? (
