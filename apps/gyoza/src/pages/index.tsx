...
const Home: NextPage = () => {
  return (
    <>
      ...
      <main className="border-background flex min-h-screen  w-full flex-col items-center justify-start border pt-64 text-primary">
        <div className="flex w-full max-w-screen-sm flex-col items-center gap-y-24">
          <div className="flex flex-col gap-y-1 text-center">
            <Heading variant="heavy">Welcome to our Ramen bar!</Heading>
            <Typography variant="xl/regular">Eat, sleep and live your dreams.</Typography>
          </div>
